...
//
///**
// * A classe PrintLogOld foi criada para ser uma alternativa ao modo DEBUG, além de
...
// *
// * Exemplo de código: PrintLogOld p = new PrintLogOld(true,"Teste do PrintLogOld");
// * p.test();
// *
// * Resultado:
// * ===================================================================================================
// * #///////////////////////////// INIT [Teste do PrintLogOld] ///////////////////////////////#
// * ===================================================================================================
// * # LOG [85]-Teste do PrintLogOld => Somente uma mensagem # LOG [86]-Teste do PrintLogOld => Mensagem com valor: valor aqui
// * ---------------------------------------------------------------------------------------------------
// * # LOG [88]-Teste do PrintLogOld => Somente outra mensagem depois das separações e antes de fechar o b
// * loco
// * ===================================================================================================
// *
// * ===================================================================================================
// * #/////////////////////////////// END [Teste do PrintLogOld] ////////////////////////////////#
// * ===================================================================================================
// *
// *
// */
...
////                    var newVal = ""
////                    for (v in list) {
////                        newVal += SYB.BREAK_LINE.symbol + v + SYB.SEMICOLON.symbol
////                    }
////                    thisValue = newVal
////                }
